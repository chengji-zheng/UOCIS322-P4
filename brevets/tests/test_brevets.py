...
def test_open_times():
    ...
    assert str(open_time(300, 300, testing_time)) == str(testing_time.shift(minutes=541))   # Testing for 400km
    ...
    assert str(open_time(1000,1000, testing_time)) == str(testing_time.shift(minutes=1986))   # Testing for 1000km
...
def test_close_time():
    ...
    assert str(close_time(300, 300, testing_time)) == str(testing_time.shift(minutes=1200))   # Testing for 400km
